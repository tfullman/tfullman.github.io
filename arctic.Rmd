...
## Create a combined Alaska Native traditional lands and caribou range polygon
combined <- 
  ## Combine the polygons
  st_union(AKnative, caribou) %>% 
  ## Dissolve this into one feature
  st_union()
...
<img src="files/arctic/Map_option_4_ARPA.png">
...
Combining traditional Indigenous homelands and caribou ranges yields a boundary covering `r combined %>% area_acres() %>% format(big.mark = ',')` acres.
...
<img src="files/arctic/Map_option_5_combined_Indigenous_caribou_range.png">
...
opts <- c('Ecoregions', 'Indigenous homelands', 'Caribou ranges', 'ARPA boundary', 'Combined 2+3')
...
* <span style="color: green;">Option 4 - </span> ARPA boundary
* <span style="color: orange;">Option 5 - </span> Options 2+3
...
tm_tmp <-
  ...
  tm_basemap(
    ...
    tm_shape(
      combined,
      name = 'Option 5 - Indigenous homelands and caribou range') +
    tm_borders(
      col = 'orange',
      lwd = 3) +
